<template>
  <div class="root">
    <input v-if="!Object.keys(selectedStudent).length" v-model="searchQuery" type="search" value="" placeholder="Searchfdsfsd Student" class="search-input search-input--material" style="width: 100%">
